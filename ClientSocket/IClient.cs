...
namespace ClientSocket
{
    public interface IClient
    {
        ...
        void RequetsDeleteFriend(string emailRequest, string emailDelete);
        void RequestCreateLiveStream(string email);
        void RequestGetListFriendStreaming(string email);
    }
}
